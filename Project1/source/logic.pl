...
/* Checks if X and Y are valid coordinates for Yuki's next play considering the Board state. Checks if X and Y are in the board's limits,
checks if Yuki doesn't move more than one block, checks if Mina, blank space or himself are not the new position and if Mina is
visible from the new position. */
...
/* Checks if X and Y are valid coordinates for Mina's next play considering the Board state. Checks if X and Y are in the board's limits,
checks if Mina moves orthogonally or diagonally, checks if Yuki or herself are not the new position and if Mina is
visible from the new position. */
